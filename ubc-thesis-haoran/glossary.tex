...
\acro{correspondence}{a pair from the matching in the form of (a,b,c), where a, b are attributes from the two schemama, and c is a score according to some matching criteria}
